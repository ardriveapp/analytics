...
async function main() {
  ...
  console.log(`Bundle Data Size (Bytes): ${totalBundleSize}`);
  console.log(`Bundle Gas Spent (AR): ${totalBundleGas}`);
  console.log(`Non Bundled Txs found: ${totalNonBundledTxsFound}`);
  console.log(`Non Bundled Data Size (Bytes): ${totalNonBundleSize}`);
  ...
  console.log(`-----------------------------------------`)
  console.log(`Total L1 Transactions: ${totalNonBundledTxsFound + l1Results.bundleTxs.length}`)
  console.log(`Total L1 Size (Bytes): ${totalBundleSize + totalNonBundleSize}`)
  console.log(`Total L1 Tip Amount (AR): ${totalBundleTips + totalFileDataTips + totalTipTxTips}`)
  console.log(`-----------------------------------------`)
