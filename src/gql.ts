...
const ardriveAppName = "ArDrive-App";
            ...
            tags.forEach((tag: any) => {
              ...
              switch (key) {
                case "App-Name":
                  ...
                  break;
                case "App-Platform":
                  arDriveStat.appPlatform = value;
                  break;
                case "App-Version":
                  arDriveStat.appVersion = value;
                  break;
                case "Drive-Privacy":
...
export async function getAllFiles(start: Date, end: Date): Promise<FileInfo[]> {
  ...
  let files: FileInfo[] = [];
  let hasNextPage = true;
  let appName = `${desktopAppName}", "${webAppName}", "${ardriveAppName}", "${coreAppName}", "${cliAppName}", "${syncAppName}`;
  try {
    while (hasNextPage) {
      const query = {
        query: `query {
              ...
              tags.forEach((tag: any) => {
                ...
                switch (key) {
                  ...
                  case "App-Version":
                    ...
                    break;
                  case "App-Platform":
                    bundle.appPlatform = value;
                    break;
                  case "App-Platform-Version":
                    bundle.appPlatformVersion = value;
                    break;
                  default:
                    break;
                }
...
// Sums up every data transaction for a start and end period and returns newest results first
export async function getAllAppUserL1Transactions(
  start: Date,
  end: Date,
  owner: string,
  appName?: string
